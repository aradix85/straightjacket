    ...
    engine_loader._eng = _ConfigNode(
        {
            ...
            "effect_resolver": {
                ...
                "move_baselines": {"strike": 1, "other": 0},
            },
            ...
            "move_routing": {
                "miss_endure": {"endure_harm": "health", "endure_stress": "spirit"},
                "recovery": {
                    "endure_harm": {"track": "health", "cap": "health_max"},
                    "endure_stress": {"track": "spirit", "cap": "spirit_max"},
                    "resupply": {"track": "supply", "cap": "supply_max"},
                },
            },
            "architect": {
                "forbidden_moods": [
