...
def available_moves(game: GameState) -> dict:
    ...
    has_vow = any(t.track_type == "vow" for t in game.vow_tracks)
    has_expedition = any(t.track_type == "expedition" for t in game.vow_tracks)
    has_scene_challenge = any(t.track_type == "scene_challenge" for t in game.vow_tracks)
    has_combat_track = any(t.track_type == "combat" for t in game.vow_tracks)
    has_connection = any(t.track_type == "connection" for t in game.vow_tracks)
